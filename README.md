...
#### 10. Командой cat добавить в текстовый файл tf_3.txt строку “the sec 2”

        $ cat >> tf_3.txt

        the sec 2

#### 11. Командой cat добавить в текстовый файл tf_2.txt строку “the sec 3”

        $ cat >> ../tf_2.txt

        the sec 3

#### 12. Командой cat добавить в текстовый файл tf_3.txt строку “the SeCoNd 2”

        $ cat >> tf_3.txt

        the SeCoNd 2

#### 13. Командой cat добавить в текстовый файл tf_2.txt строку “the seConD 2”
...
Команда `seq` выводит заданную последовательность чисел, которую мы с помощью команды `cat` записываем в файл:   
        
        $ seq 15 | cat > tf_4.txt
        
Для создания более содержательной записи можно использовать цикл:
        
        $ for i in {1..15}; do echo "This is the line number ${i}"; done > tf_4.txt
